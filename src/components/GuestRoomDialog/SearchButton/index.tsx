...
export const SearchButton: FC<SearchButtonPropTypes> = ({ onSearch }) => {
  ...
  return (
    <div className={buttonWrapperStyle}>
      {/* <Button onClick={search(guestRooms, onSearch)} fullWidth  className={updateSearch}>
        Search {roomsCountText} • {guestsCountText}
      </Button> */}

      <Button onClick={()=>{alert(`Guest Selected =${guestsCountText} and total rooms =${roomsCountText}` )}} fullWidth  className={updateSearch}>
        Search {roomsCountText} • {guestsCountText}
      </Button>
